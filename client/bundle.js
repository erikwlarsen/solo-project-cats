...
var Gif = __webpack_require__(28);
var $ = __webpack_require__(29);

var imageArray = ['https://media3.giphy.com/media/26FPCXdkvDbKBbgOI/200w.gif', 'https://media3.giphy.com/media/v6aOjy0Qo1fIA/200w.gif', 'https://media3.giphy.com/media/W3QKEujo8vztC/200w.gif', 'https://media2.giphy.com/media/vFKqnCdLPNOKc/200w.gif', 'https://media3.giphy.com/media/6uMqzcbWRhoT6/200w.gif'];
...
$.ajax('https://api.giphy.com/v1/gifs/search?api_key=MW5czB76HwkBu7TtxFZ4brmlICTLCLNA&q=cat&limit=100&offset=0&rating=G&lang=en', {
  type: 'GET',
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      var gifElements = [React.createElement(Gif, { key: 0, gif: this.state.leftGif }), React.createElement(Gif, { key: 1, gif: this.state.rightGif })];
...
var Gif = function Gif(props) {
  return React.createElement('img', { src: props.gif, width: 400 });
};
